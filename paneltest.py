...
#		theaterChase(strip, Color(127, 127, 127), 5)  # White theater chase
#		theaterChase(strip, Color(127,   0,   0), 5)  # Red theater chase
#		theaterChase(strip, Color(  0,   0, 127), 5)  # Blue theater chase
...
#                print ('Left/Right 50')
#                leftright(strip, 50)
#                print ('Left/Right 200')
#                leftright(strip, 200)
#                print ('Blinking 250')
#                blink(strip, 250)
#                print('Blinking 500')
#                blink(strip, 500)
                blinkPanels(strip,  250)
